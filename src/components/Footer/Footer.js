    ...
    <>
      <section className={style.block}>
        ...
        <div className={style.footer__blocks}>
          ...
          <article
            className={`${style.footer__block} ${style.footerblock__right}`}
          >
        ...
        <div className={style.footing}>
          <h3 className={style.footing__p}>
            &copy;2020 Devine Integration - student project by Amber Pérard,
            Ellen Sierens &amp; Julia Anseele
          </h3>
        </div>
      </section>
    </>
